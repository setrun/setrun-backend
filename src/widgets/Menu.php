...
namespace setrun\backend\widgets;

use Yii;
use yii\helpers\{Url, Html};
use setrun\sys\helpers\{ArrayHelper, FileHelper};
...
class Menu extends \yii\widgets\Menu
{
    ...
    protected function isItemActive($item)
    {
        if (isset($item['controller'])) {
            if ($item['controller'] === Yii::$app->controller->id) {
                unset($item['url']['#'], $item['controller']);
                return true;
            }
        }
        return false;
    ...
    {
       return FileHelper::loadExtensionsFiles('config/backend/menu.php');
    }
}